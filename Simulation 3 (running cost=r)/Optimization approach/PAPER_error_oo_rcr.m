                ...
                for i5=1:length(up0)
                    ...
                    for i6=1:length(vp0)
                        ...
                        for i7=1:length(ue0)
                            ...
                            for i8=1:length(ve0)
                                param.ve0=ve0(i8);
                                % Optimization in three dimensions: in this
                                ...
                                while lp
                                    ...
                                    switch nit
                                        ...
                                        otherwise
                                            ...
                                            out(i1,i2,i3,i4,i5,i6,i7,i8,2)=1e5;
                                    end
                                    x'.*denorm_vector'-[0 0 param.dv/2]'
